...
def main(page: ft.Page):
    ...
    content = ft.Column(
        controls=[
            ft.Text("Welcome to My Portfolio!", style=ft.TextThemeStyle.HEADLINE_MEDIUM),
    ...
    def nav_click(e):
        ...
        if e.control.selected_index == 0:
            ...
            content.controls = [
                ft.Text("About Me", style=ft.TextThemeStyle.HEADLINE_MEDIUM),
                ft.Text("A brief introduction about yourself, your background, and skills.")
            ]
        elif e.control.selected_index == 2:
            content.controls = [
                ft.Text("Projects", style=ft.TextThemeStyle.HEADLINE_MEDIUM),
                ft.Text("List or showcase your projects here with images, descriptions, and links.")
            ]
        elif e.control.selected_index == 3:
            content.controls = [
                ft.Text("Contact",  style=ft.TextThemeStyle.HEADLINE_MEDIUM),
